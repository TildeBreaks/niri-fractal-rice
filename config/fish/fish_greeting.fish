function fish_greeting
    ...
    if test -f "$random_fractal"
        fastfetch --logo $random_fractal --logo-type kitty-direct --logo-width 30 --logo-height 20
...
PYEOF
                ...
                sed -i 's/size=\"[0-9]* [0-9]*\"/size=\"1920 1080\"/' \$temp_genome
                sed -i 's/scale=\"[0-9.]*\"/scale=\"300\"/' \$temp_genome
                sed -i 's/oversample=\"[0-9]*\"/oversample=\"2\"/' \$temp_genome
                sed -i 's/quality=\"[0-9]*\"/quality=\"800\"/' \$temp_genome
