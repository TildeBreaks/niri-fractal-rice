...
echo "2. To change your wallpaper and apply a new theme, run one of the wallpaper scripts:"
echo "   - 'change-wallpaper' (for a GUI picker)"
echo "   - 'wallpaper-selector.sh /path/to/your/image.png'"
echo "   This will use 'swww' to set the background and then trigger the 'pywal' color cascade."
